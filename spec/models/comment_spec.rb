...
RSpec.describe Comment, type: :model do
  ...
  before(:each) do
    @user = User.new(id: 1, name: 'Ben', bio: 'My bio about my self and else', photo: '', posts_count: 0)
    @post = Post.new(title: 'Post1', text: 'Some text about the post', comments_count: 4, likes_count: 1,
                     author_id: @user.id)
