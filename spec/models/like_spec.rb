...
RSpec.describe Like, type: :model do
  before(:each) do
    @user = User.new(id: 1, name: 'Ben', bio: 'I am a content creator', photo: '', posts_count: 0)
    @post = Post.new(title: 'Post1', text: 'Text...', comments_count: 0, likes_count: 1, author_id: @user.id)
